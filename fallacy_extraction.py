...
COMBINED_LEVEL_2 = {
    "nothing": ["nothing", "none", "non-fallacious", "not fallacious"],
    "hasty generalization": ["generalization", "hasty_generalization"],
    "causal oversimplification": ["oversimplification", "causal_oversimplification"],
    "appeal to ridicule": ["ridicule", "appeal_to_ridicule"],
    "false dilemma": ["dilemma", "false_dilemma"],
    "ad hominem": ["hominem", "ad_hominem"],
    "ad populum": ["populum", "ad_populum"],
    "straw man": ["straw", "strawman", "straw_man"],
    "false causality": ["causality", "false_causality"],
    "false analogy": ["analogy", "false_analogy"],
    "slippery slope": ["slippery", "slope", "slippery_slope"],
    "appeal to fear": ["fear", "appeal_to_fear"],
    "appeal to nature": ["nature", "appeal_to_nature"],
    "circular reasoning": ["circular", "circular_reasoning"],
    "appeal to (false) authority": ["authority", "appeal_to_authority"],
    "appeal to worse problems": ["worse", "problems", "appeal_to_worse_problems"],
    "guilt by association": ["association", "guilt_by_association"],
    "equivocation": ["equivocation"],
    "appeal to tradition": ["tradition", "appeal_to_tradition"],
    "appeal to anger": ["anger", "appeal_to_anger"],
    "appeal to positive emotion": ["positive", "appeal_to_positive_emotion"],
    "tu quoque": ["quoque", "tu_quoque"],
    "fallacy of division": ["division", "fallacy_of_division"],
    "appeal to pity": ["pity", "appeal_to_pity"],
    "fallacy of relevance": ["relevance", "fallacy_of_relevance"],
    "intentional": ["intentional"],
    "appeal to emotion": ["emotion", "appeal_to_emotion"],
}
